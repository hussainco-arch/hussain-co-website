...
export function BonusesIncentivesCard(props) {
  const {
    bonusesValue,
    incentivesValue,
    borderColor,
  ...
  return (
    ...
    >
      <motion.div
        className={`${backgroundColor} ${borderColor} border rounded-xl overflow-hidden shadow-lg bg-white relative`}
      >
        ...
        <div className="relative pl-4 pr-8 pb-4 pt-8 overflow-hidden">
          ...
          <div
            ...
            style={{
              background: 'linear-gradient(to bottom, transparent 0%, transparent 35%, rgba(255, 255, 255, 0.8) 45%, rgba(255, 255, 255, 0.9) 55%, rgba(255, 255, 255, 1) 65%)',
              zIndex: 5
            }}
          />
